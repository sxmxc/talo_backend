...
describe('GT rule', () => {
  ...
  it('should correctly evaluate a GT rule with stat values', async () => {
    const [organization, game] = await createOrganizationAndGame()
    const [token] = await createUserAndToken({}, organization)
  ...
  it('should correctly evaluate a negated GT rule with stat values', async () => {
    const [organization, game] = await createOrganizationAndGame()
    const [token] = await createUserAndToken({}, organization)
  ...
  it('should correctly evaluate a GT rule with leaderboard entry scores', async () => {
    const [organization, game] = await createOrganizationAndGame()
    const [token] = await createUserAndToken({}, organization)
  ...
  it('should correctly evaluate a negated GT rule with leaderboard entry scores', async () => {
    const [organization, game] = await createOrganizationAndGame()
    const [token] = await createUserAndToken({}, organization)
